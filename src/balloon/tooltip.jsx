...
export default class Tooltip extends React.Component {
    ...
    beforePosition = (result, obj) => {
        ...
        if(!result) {
            console.log('tooltip beforePosition result is null')
            return result;
        }

        const { placement } = result.config || {};
        if (placement && placement !== this.state.align) {
            this.setState({
                align: placement,
                innerAlign: true,
            });
        ...
        if (this.props.arrowPointToCenter) {
            ...
            if (!result.style || !obj || !obj.target) {
                console.log('tooltip beforePosition params exists null')
                return ;
            }
