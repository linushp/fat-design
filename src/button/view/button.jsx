...
import { obj, log , ReactComponent } from '../../util';
...
export default class Button extends ReactComponent {
    ...
    buttonRefHandler = button => {
        this.button = button;
        this.saveFatNodeInstance(button);
    };
    ...
    buildIcon(iconType){
        ...
        const className = classNames({
            ...
            [`${prefix}btn-icon-pre`]: true
        });
        const Icon = ComponentsStore.buildInComponents['Icon'];
    ...
    render() {
        ...
        const clonedChildren = Children.map(children, (child, index) => {
            if (isChildTypeComp(child) && child.type._typeMark === 'icon') {
        ...
        const iconElement = this.buildIcon(iconType);
