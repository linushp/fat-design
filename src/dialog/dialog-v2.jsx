...
import Overlay from '../overlay/v2';

import Inner from './inner';
import Animate from '../animate';
import zhCN from '../locale/zh-cn';
import { log, func, dom, focus, guid, findDOMNode, createPortal } from '../util';
import scrollLocker from './scroll-locker';
import {defaultWidth} from "./constants.jsx";
    ...
    useEffect(() => {
        if (visible && hasMask) {
            ...
            if (dom.hasScroll(document.body)) {
                ...
                if (scrollWidth) {
                    style.paddingRight = `${
                        dom.getStyle(document.body, 'paddingRight') +
                        dom.scrollbar().width
                    }px`;
                }
            }
