...
export default class Drawer extends Component {
    ...
    getStyle = (placement)=>{
        ...
        const assign = (top, right, bottom, left, width, height) => {
            Object.assign(newStyle, {top, left, right, bottom, width, height});
        }

        switch (placement) {
            case 'top':
                assign(0, 0, 'auto', 0, '100%', height || DEFAULT_HEIGHT);
                break;
            case 'bottom':
                assign('auto', 0, 0, 0, '100%', height || DEFAULT_HEIGHT);
                break;
            case 'left':
                assign(0, 'auto', 0, 0, width || DEFAULT_WIDTH, '100%');
                break;
            case 'right':
            default:
                assign(0, 0, 0, 'auto', width || DEFAULT_WIDTH, '100%');
                break;
        }
    ...
    render() {
        ...
        const newStyle = this.getStyle(placement);
