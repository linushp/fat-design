...
import {DrawerFooter} from "./footer.jsx";
...
export default class Inner extends Component {
    ...
    render() {
        const {prefix, className, closeable, placement, role, rtl , style } = this.props;
        ...
        return (
            <div className={newClassName} style={style} dir={rtl ? 'rtl' : undefined}>
