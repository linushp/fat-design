...
const Operations: React.FC<OperationsProps> = props => {
  ...
  const {rotateLeft, rotateRight, zoomIn, zoomOut, close, left, right, flipX, flipY} = buildIcons(icons);
  ...
  return (
      <div className={classnames(`${prefixCls}-operations-wrapper`, rootClassName)} >
