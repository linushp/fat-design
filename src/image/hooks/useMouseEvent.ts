...
import addEventListener, {IaddEventListenerWrapRes} from '../utils/addEventListener';
...
function warning(...args:any){
  console.log('useMouseEvent warning',...args);
}
...
export default function useMouseEvent(
  ...
  useEffect(() => {
    let onTopMouseUpListener: IaddEventListenerWrapRes;
    let onTopMouseMoveListener: IaddEventListenerWrapRes;
    let onMouseUpListener:IaddEventListenerWrapRes;
    let onMouseMoveListener:IaddEventListenerWrapRes;
