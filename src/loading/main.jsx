...
function renderLoading({prefix, style, loadingCls, tipCls, visible, indicatorDom, tip, others, contentCls, children}) {
    const maskerStyle = {};
    const tipClsStyle = {};

    // 提升渲染性能
    if (!visible) {
        maskerStyle.display = 'none';
        tipClsStyle.display = 'none';
    }

    return (
        <div className={loadingCls} style={style} {...others}>
            <div className={tipCls} style={tipClsStyle}>
            ...
            <div className={contentCls}>
                <div className={`${prefix}loading-masker`} style={maskerStyle}/>
                {children}
            </div>
        </div>
    )
...
class Loading extends React.Component {
    ...
    render() {
        ...
        return fullScreen ? (
            ...
            renderLoading({prefix, style, loadingCls, tipCls, visible, indicatorDom, tip, others, contentCls, children})
        );
    }
}
