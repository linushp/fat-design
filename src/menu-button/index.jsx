...
import { obj, func, findDOMNode, polyfill } from '../util';
...
class MenuButton extends React.Component {
    ...
    onPopupOpen = () => {
        const button = findDOMNode(this.triggerRef);
    ...
    render() {
        ...
        const trigger = (
            <Button style={style}
                ...
                ref={this._saveTriggerRef}
            >
                {label} <Icon type="arrow-down" className={arrowIconCls} />
            </Button>
        );
