 ...
 * @returns
 */
export const getRelativeContainer = (container) => {
  if (typeof document === 'undefined') {
    return container;
  }

  let calcContainer = container;
 ...
 * @returns
 */
export const getOverflowNodes = (targetNode, container) => {
  if (typeof document === 'undefined') {
    return [];
  }
 ...
 */
const isContentClippedElement = (element) => {
