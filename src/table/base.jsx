...
import { log, obj, dom, findDOMNode, shallowElementEquals, polyfill } from '../util';
        ...
        const getChildren = children => {
            ...
            Children.forEach(children, child => {
                if (child) {
                    ...
                    if (!(
                        isChildTypeComp(child) && (child.type._typeMark === 'column' || child.type._typeMark === 'columnGroup'))
                    ) {
