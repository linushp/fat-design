...
import { func, log, polyfill } from '../util';
...
export default function selection(BaseComponent) {
    ...
    class SelectionTable extends React.Component {
        ...
        renderSelectionBody = (value, index, record) => {
            ...
            const checked = selectedRowKeys.indexOf(primaryKeyValue) > -1;
            ...
            const compKey = `checkbox_key_${primaryKeyValue || index}`

            return mode === 'multiple' ? (
                <Checkbox checked={checked} onChange={onChange} {...attrs} key={compKey} />
            ) : (
                <Radio checked={checked} onChange={onChange} {...attrs} key={compKey} />
            );
        };
