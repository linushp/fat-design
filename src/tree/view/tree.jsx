...
import { func, dom, obj, KEYCODE, polyfill, findDOMNode } from '../../util';
...
export class Tree extends Component {
    ...
    scrollFilterNodeIntoView(arg) {
        const { prefix } = this.props;
        try {
            const treeNode = findDOMNode(this.normalListRef.current);
            const itemNode = treeNode.querySelector(`.${prefix}tree-node.${prefix}filtered`);
            if (!itemNode) return;
    ...
    filterTreeNode(node) {
        return this.props.filterTreeNode(node);
    }
