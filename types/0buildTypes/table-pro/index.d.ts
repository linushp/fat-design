...
declare class TablePro extends React.Component<TableProProps, any> {
     ...
     */
    static getTableStyleBySetting: (settingName: string) => Promise<any>;
    /**
     * 渲染表格工具栏
     ...
     * @returns React 元素
     */
    static renderStringExt: (value: any, options: IRenderStringExtOptions) => React.JSX.Element;
    /**
     * 渲染日期（YYYY-MM-DD）
     ...
     * @returns 格式化的时长字符串
     */
    static renderTimeDuration: (value: any, options?: IRenderTimeDurationOptions) => string;
    /**
     * 渲染文件下载链接
     * 将文件 URL 渲染为可点击的下载链接
