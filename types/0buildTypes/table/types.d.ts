...
export interface ColumnProps extends HTMLAttributesWeak, CommonProps {
     ...
     * Function(value, index, record, context) => Element
     */
    cell?: React.ReactElement<any> | React.ReactNode | ((value: any, index: number, record: any, context?: any) => any);
    /**
     * 透传给 cell 函数的第 4 个参数，任意值，Table 内部不会修改它。
     * 常见用法是传页面实例 `context: this`，这样 cell 函数内可以直接访问页面的 state 和方法，无需 bind。
     *
     * 示例:
     * `{ dataIndex: 'op', context: this, cell: (value, index, record, context) => <Button onClick={() => context.doSomething(record)} /> }`
     */
    context?: any;
    /**
     * 表头显示的内容
...
export declare class GroupHeader extends React.Component<GroupHeaderProps, any> {
}
...
export declare class GroupFooter extends React.Component<GroupFooterProps, any> {
}
