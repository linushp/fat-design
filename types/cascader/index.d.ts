...
export type CascaderOnChangeExtra = {
    /**
     * 单选时选中的数据的路径
     */
...
export interface CascaderProps extends HTMLAttributesWeak, CommonProps {
     ...
     * 选中值改变时触发的回调函数
     */
    onChange?: (value: string | Array<string>, data: CascaderDataItem | Array<CascaderDataItem>, extra: CascaderOnChangeExtra) => void;
     ...
     * 每列列表项渲染函数
     */
    itemRender?: (data: CascaderDataItem) => React.ReactNode;

    /**
     * 异步加载数据函数，source是原始对象
     */
    loadData?: (data: CascaderDataItem, source: CascaderDataItem) => void;
