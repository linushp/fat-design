...
export interface BoolCheckboxProps extends BoolCheckboxProps {
    value?: boolean;
}

export class BoolCheckbox  extends React.Component<BoolCheckboxProps, any>{}

export default class Checkbox extends React.Component<CheckboxProps, any> {
    static Group: typeof Group;
    static BoolCheckbox: typeof BoolCheckbox;
}
