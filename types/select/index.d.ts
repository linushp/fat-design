...
export type AutoCompleteValueType = string | number | null;
...
export interface AutoCompleteProps extends HTMLAttributesWeak, CommonProps {
     ...
     * 初始化的默认值
     */
    defaultValue?: AutoCompleteValueType;
     ...
     * 渲染 MenuItem 内容的方法
     */
    itemRender?: (item: ISelectItem) => React.ReactNode;
...
export interface SelectProps extends Omit<HTMLAttributesWeak, 'renderPreview'>, CommonProps {
     ...
     * 渲染 MenuItem 内容的方法
     */
    itemRender?: (item: ISelectItem, searchValue: string) => React.ReactNode;
